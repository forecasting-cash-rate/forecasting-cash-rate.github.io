...
# setup these 
forecast_day    = "2024-07-30"        # this forecast was performed on
...
###############################################################
all_forecasts = array(NA, c(dim(pooled_forecasts_m), 5))
all_forecasts[,,1] = pooled_forecasts_m
all_forecasts[,,2] = pooled_forecasts_wm[-(13:14),]
all_forecasts[,,3] = pooled_forecasts_f
all_forecasts[,,4] = pooled_forecasts_v
all_forecasts[,,5] = pooled_forecasts_garchm
...
###############################################################
<!-- cp forecasts/2024-07.csv forecasts-backup/2024-07.csv -->
```

> Happy Beautiful Misty Winter! Have a look at my late July forecasts prepared to answer the RBA cash rate survey by [finder.com.au](https://www.finder.com.au/rba-cash-rate).
...
|          | Aug 2024 | Sep 2024 | Nov 2024 | Dec 2024 | Feb 2025 | Mar 2025 | May 2025 | Jul 2025 | Aug 2025 or beyond |
|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
| Increase |          |          |          |          |          |          |          |          |                   |
| Hold     |  ✓        | ✓        |          |          |          |          |          |          |                   |
| Decrease |          |          |          |          |          |          |          |          |                   |
