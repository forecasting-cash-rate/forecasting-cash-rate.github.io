...
# setup these 
forecast_day    = "2024-06-11"        # this forecast was performed on
...
###############################################################
all_forecasts = array(NA, c(dim(pooled_forecasts_m), 6))
all_forecasts[,,1] = pooled_forecasts_m
all_forecasts[,,2] = pooled_forecasts_wm[-(13:14),]
all_forecasts[,,3] = pooled_forecasts_garchm
all_forecasts[,,4] = pooled_forecasts_garchwm[-(13:14),]
all_forecasts[,,5] = pooled_forecasts_f
all_forecasts[,,6] = pooled_forecasts_v
...
###############################################################
<!-- cp forecasts/2024-04.csv forecasts-backup/2024-04.csv -->
```

> Happy Wintertime! Have a look at my early June forecasts prepared to answer the RBA cash rate survey by [finder.com.au](https://www.finder.com.au/rba-cash-rate).

## Cash rate forecasts

The figure below presents the monthly cash rate series starting from January 2010, with the forecasts reported from June 2024 to May 2025 as the forecast mean and the 68% forecasting intervals.
...
|          | Jun 2024 | Aug 2024 | Sep 2024 | Nov 2024 | Dec 2024 | Feb 2025 | Mar 2025 | May 2025 | Jul 2025 or beyond |
|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
| Increase |          |          |          |          |          |          |          |          |                   |
| Hold     | ✓        | ✓        |          |          |          |          |          |          |                   |
| Decrease |          |          |          |          |          |          |          |          |                   |
