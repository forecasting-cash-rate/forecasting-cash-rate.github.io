...
# setup these 
forecast_day    = "2023-10-31"        # this forecast was performed on
...
###############################################################
cp forecasts/2023-10.csv forecasts-backup/2023-10.csv
```

> The end-of-October forecasting for the RBA cash rate survey by [finder.com.au](https://www.finder.com.au/rba-cash-rate) follows the announcement of September quarterly inflation 5.4%.

## Cash rate forecasts

The figure below presents the monthly cash rate series starting from January 2010, with the forecasts reported from November 2023 to October 2024 as the forecast mean and the 68% forecasting intervals.
