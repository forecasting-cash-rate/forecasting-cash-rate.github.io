...
# setup these 
forecast_day    = "2023-11-29"        # this forecast was performed on
...
###############################################################
cp forecasts/2023-11.csv forecasts-backup/2023-11.csv
```

> The end-of-November forecasting for the RBA cash rate survey by [finder.com.au](https://www.finder.com.au/rba-cash-rate) follows the announcement of October quarterly inflation 4.9%.
