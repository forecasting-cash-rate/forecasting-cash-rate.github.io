...
# setup these 
forecast_day    = "2023-09-27"        # this forecast was performed on
...
###############################################################
cp forecasts/2023-09.csv forecasts-backup/2023-09.csv
```

> The end-of-September forecasting for the RBA cash rate survey by [finder.com.au](https://www.finder.com.au/rba-cash-rate) follows the announcement of August monthly inflation 5.2%.

## Cash rate forecasts

The figure below presents the monthly cash rate series starting from January 2010, with the forecasts reported from October 2023 to September 2024 as the forecast mean and the 68% forecasting intervals.
...
|          | Oct 2023 | Nov 2023 | Dec 2023 | Feb 2024 | Mar 2024 | Apr 2024 | May 2024 | Jun 2024 | Jul 2024 or later |
|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|
| Increase |         |         |         |          |          |          |          |          |                   |
| Decrease |          |          |          |          |          |          |          |          |                   |
...
TBA on 3 October 2023.

## Forecasting system

My forecasting system for September is based on the cash rate target and government bond yields at various maturities as presented in the figure below.
...
The system consists of a 192 of models. Half of them are are models of weekly and the other half of monthly data.
