...
ym13 = zoo::as.yearmon("2023-07") # forecast origin
...
sw[1] = as.Date("2023-08-01") # the first forecast date
for (i in 2:55) {
  sw[i] = sw[i - 1] + 7
}
...
zoo::write.zoo(pooled_forecasts, sep = ",", file = "forecasts/2023-07.csv")
