...
# setup these 
forecast_day    = "2025-03-26"        # this forecast was performed on
...
###############################################################
<!-- cp forecasts/2025-03.csv forecasts-backup/2025-03.csv -->
```

> Happy Autumn! Have a look at my March forecasts prepared to answer the RBA cash rate survey by [finder.com.au](https://www.finder.com.au/rba-cash-rate).
